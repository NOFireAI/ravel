...
mod prefetch_tests {
    ...
    async fn spawn_metric_worker(
        ...
        let resolver = Arc::new(crate::distrib::service::SnapshotSegmentResolver::new(segments));
        let service =
    ...
    async fn count_over_time_pushdown_on_and_off_agree() {
        ...
        let backend_b: Arc<dyn ObjectStoreBackend> = Arc::clone(&store_b) as Arc<dyn ObjectStoreBackend>;
