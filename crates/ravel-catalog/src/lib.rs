...
pub use config::{
    ...
    MAX_CACHE_CAPACITY_PER_TENANT, MAX_RECORD_CACHE_BYTES_PER_TENANT, MAX_RESOLVE_GET_CONCURRENCY,
    MEMORY_BOUNDED_RESOLVE_GET_CONCURRENCY, RECORD_CACHE_ENTRY_BYTES, RECORD_CACHES_PER_TENANT,
    RESOLVE_GET_CONCURRENCY_PER_STORE_GET, RESOLVE_INFLIGHT_BYTES_PER_REQUEST,
    RESOLVE_INFLIGHT_MAX_BYTES, derive_cache_capacity_per_tenant, derive_resolve_get_concurrency,
};
