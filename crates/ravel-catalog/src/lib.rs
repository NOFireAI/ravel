...
pub use config::{
    ...
    DEFAULT_CLOCK_SKEW_ALLOWANCE_NS, DEFAULT_FOLD_RECONCILE_WINDOW_HOURS,
    DEFAULT_FOLD_SAFETY_MARGIN_NS, DEFAULT_FRONTIER_RECONCILE_MAX_HOURS,
    DEFAULT_HEAD_CACHE_CAPACITY, DEFAULT_HEAD_CACHE_TTL_NS, DEFAULT_MAX_CATALOG_LIST_REQUESTS,
    DEFAULT_MAX_FLUSH_LIFETIME_NS, DEFAULT_MAX_INGEST_LAG_NS, DEFAULT_POSTINGS_CACHE_ENTRIES,
    DEFAULT_PREFIX_LIST_CROSSOVER_REQUESTS, DEFAULT_PROTECTION_HORIZON_NS,
...
pub use provisioning::{
    ...
    shard_count_drift_count, validate_or_adopt,
};
