...
pub use format::{
    ReaderLimits, SUPPORTED_VERSIONS, SegmentVersion, SupportedVersions, TRAILER_LEN,
    V5_SPARSE_THRESHOLD, V5_STRIDE, VERSION_V6, VERSION_V7,
};
...
pub use reader::{
    ...
    SeriesEntryV4, TrailerClass, ValPageKind, ValueKind, classify_trailer,
