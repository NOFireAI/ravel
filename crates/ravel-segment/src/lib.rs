...
pub use reader::{
    FooterLocation, FooterOutcome, PlannedRange, SeriesEntry, decode_catalog,
    decode_catalog_matching, decode_pages, open_from_full, open_from_suffix, parse_footer,
    plan_ranges, select, validate_sections,
};
pub use writer::{
