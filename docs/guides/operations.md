...
| `--distribute-segments-threshold <n>` | | `64` | The segment-count axis of the fan-out cost gate. Either axis alone trips the gate. Meaningful only with `--distributed-query`. |
