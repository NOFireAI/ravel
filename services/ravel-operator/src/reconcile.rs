...
mod tests {
    ...
    fn qualify_job_carries_allow_http_only_when_set() {
        ...
        // clap reads a bool flag's env var as set-if-present with a truthy
        // value; "true" is the spelling the server's own deployment manifests
        // would use, and an empty value would read as unset.
        assert_eq!(
