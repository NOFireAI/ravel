...
if [[ "${FLEET_MERGE_AUTO:-0}" == "1" ]]; then
  ...
  echo "                  gh api repos/NOFireAI/ravel/pulls/${pr_number}/comments   # inline findings"
  echo "                  gh api repos/NOFireAI/ravel/issues/${pr_number}/comments  # the bot's task comment"
